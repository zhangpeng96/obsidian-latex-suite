[    
    ...
    {trigger: "Tr", replacement: "\\triangle", options: "mA"},
    {trigger: "!=", replacement: "\\neq", options: "mA"},
    {trigger: ">=", replacement: "\\geq", options: "mA"},
    {trigger: "<=", replacement: "\\leq", options: "mA"},
    {trigger: "([^\\\\])ge", replacement: "[[0]]\\geqslant", options: "rmA"},
    {trigger: "([^\\\\])le", replacement: "[[0]]\\leqslant", options: "rmA"},
    ...
    {trigger: "pa([A-Za-z])([A-Za-z])([A-Za-z])", replacement: "\\dfrac{ \\partial^{2} [[0]] }{ \\partial [[1]] \\partial [[2]] } ", options: "rm"},
    {trigger: "pa([A-Za-z])([A-Za-z])2", replacement: "\\dfrac{ \\partial^{2} [[0]] }{ \\partial [[1]]^{2} } ", options: "rmA"},
    {trigger: "de([A-Za-z])([A-Za-z])", replacement: "\\dfrac{ \\mathrm{d}[[0]] }{ \\mathrm{d}[[1]] } ", options: "rm"},
    {trigger: "de([A-Za-z])([A-Za-z])2", replacement: "\\dfrac{ d^{2}[[0]] }{ d[[1]]^{2} } ", options: "rmA"},
    {trigger: "ddt", replacement: "\\dfrac{\\mathrm{d}}{\\mathrm{d}t} ", options: "mA"},
    ...
    {trigger: "puni", replacement: "\$\\pu{ $0 }\$$1", options: "tA"},
    ...
    // Misc
    {trigger: "tayl", replacement: "${0:f}(${1:x} + ${2:h}) = ${0:f}(${1:x}) + ${0:f}'(${1:x})${2:h} + ${0:f}''(${1:x}) \\dfrac{${2:h}^{2}}{2!} + \\dots$3", options: "mA"},
]
